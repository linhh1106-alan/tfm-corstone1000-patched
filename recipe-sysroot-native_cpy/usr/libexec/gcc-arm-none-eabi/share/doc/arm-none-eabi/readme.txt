...
On Linux and macOS, either invoke with the complete path like this:
    ...
    $ ${install_dir}/gcc-arm-11.2-2022.02-<HOST_ARCH>-arm-none-eabi/bin/arm-none-eabi-gcc
...
Or set the path and then invoke the toolchain like this:
    ...
    $ export PATH=$PATH:${install_dir}/gcc-arm-11.2-2022.02-<HOST_ARCH>-arm-none-eabi/bin
