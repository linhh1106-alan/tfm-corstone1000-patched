...
#define __GMP_CC "gcc "
#define __GMP_CFLAGS "-O2 -pedantic -march=armv8-a -isystem/work/tmp/work/corstone1000_fvp-poky-linux-musl/trusted-firmware-m/1.6.0-r0/recipe-sysroot-native/usr/include -O2 -pipe"
